...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/l-yc.github.io/physics-website/flexsearch.min.js');loadScript('/l-yc.github.io/physics-website/en.search-data.min.6913042278ee601aa6095de9f158ac978d165560831638a34a91595569312e46.js',function(){input.required=false;search();});}
